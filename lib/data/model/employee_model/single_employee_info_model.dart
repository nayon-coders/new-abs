...
//
//     final singleEmploueeInfo = singleEmploueeInfoFromJson(jsonString);

import 'dart:convert';

SingleEmployeeInfo singleEmploueeInfoFromJson(String str) => SingleEmployeeInfo.fromJson(json.decode(str));

String singleEmploueeInfoToJson(SingleEmployeeInfo data) => json.encode(data.toJson());

class SingleEmployeeInfo {
  final bool? success;
  ...
  factory SingleEmployeeInfo.fromJson(Map<String, dynamic> json) => SingleEmployeeInfo(
...
class Employee {
  ...
  factory Employee.fromJson(Map<String, dynamic> json) => Employee(
    ...
    duePayment: json["due_payment"]?.toDouble(),
