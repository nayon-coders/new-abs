...
//
//     final topicWithBookIdMolde = topicWithBookIdMoldeFromJson(jsonString);

import 'dart:convert';

TopicWithBookIdMolde topicWithBookIdMoldeFromJson(String str) => TopicWithBookIdMolde.fromJson(json.decode(str));

String topicWithBookIdMoldeToJson(TopicWithBookIdMolde data) => json.encode(data.toJson());

class TopicWithBookIdMolde {
  final bool? success;
  ...
  factory TopicWithBookIdMolde.fromJson(Map<String, dynamic> json) => TopicWithBookIdMolde(
