...
<body>
    ...
    <ul>
        ...
        <li><strong>Application</strong> refers to All Business Solution, the software program provided by the Company.</li>
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to All Business Solution, 123 Fifth Avenue, New York, NY 12004, USA.</li>
    ...
    <ul>
        ...
        <li>By visiting this page on our website: <a href="https://www.allbusinesssolution.com/contact">https://www.allbusinesssolution.com/contact</a></li>
